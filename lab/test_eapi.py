"""Live lab checks for PQC-hybrid eAPI (HTTPS + command-api)."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Verify live eAPI PQC connectivity.")
    ...
    try:
        ...
        report_summary("eAPI", str(exc), CheckStatus.FAIL, file=sys.stderr)
